  ...
  if (hasConversation) {
    return (
      ...
      >
        ...
        Ver conversación con {firstName}
      </button>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="border border-gray-100 rounded-xl p-4 space-y-3">
      <div className="flex items-center justify-between">
        <p className="text-sm font-medium text-gray-700">Mensaje para {firstName}</p>
      ...
      <textarea
        ...
        placeholder={`Hola ${firstName}, estoy interesado en tu viaje...`}
        rows={3}
        required
